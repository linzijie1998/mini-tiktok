...
import (
	...
	"github.com/linzijie1998/mini-tiktok/cmd/api/biz/model/douyin/feed"
)
...
func (p *FavoriteServiceClient) FavoriteAction(ctx context.Context, req *ActionRequest) (r *ActionResponse, err error) {
	...
	if err = p.Client_().Call(ctx, "favorite_action", &_args, &_result); err != nil {
		return
	}
...
func (p *FavoriteServiceClient) FavoriteList(ctx context.Context, req *ListRequest) (r *ListResponse, err error) {
	...
	if err = p.Client_().Call(ctx, "favorite_list", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewFavoriteServiceProcessor(handler FavoriteService) *FavoriteServiceProcessor {
	...
	self.AddToProcessorMap("favorite_action", &favoriteServiceProcessorFavoriteAction{handler: handler})
	self.AddToProcessorMap("favorite_list", &favoriteServiceProcessorFavoriteList{handler: handler})
	return self
}
...
func (p *favoriteServiceProcessorFavoriteAction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if err = args.Read(iprot); err != nil {
		...
		oprot.WriteMessageBegin("favorite_action", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	if retval, err2 = p.handler.FavoriteAction(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing favorite_action: "+err2.Error())
		oprot.WriteMessageBegin("favorite_action", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("favorite_action", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
...
func (p *favoriteServiceProcessorFavoriteList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("favorite_list", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	if retval, err2 = p.handler.FavoriteList(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing favorite_list: "+err2.Error())
		oprot.WriteMessageBegin("favorite_list", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("favorite_list", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
func (p *FavoriteServiceFavoriteActionArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("favorite_action_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *FavoriteServiceFavoriteActionResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("favorite_action_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
...
func (p *FavoriteServiceFavoriteListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("favorite_list_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *FavoriteServiceFavoriteListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("favorite_list_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
