...
type Message struct {
	...
	CreateDate *string `thrift:"create_date,5,optional" frugal:"5,optional,string" json:"create_date,omitempty"`
}
...
var Message_CreateDate_DEFAULT string

func (p *Message) GetCreateDate() (v string) {
	if !p.IsSetCreateDate() {
		return Message_CreateDate_DEFAULT
	}
	return *p.CreateDate
}
...
func (p *Message) SetCreateDate(val *string) {
	p.CreateDate = val
}
...
func (p *Message) IsSetCreateDate() bool {
	return p.CreateDate != nil
}
...
func (p *Message) Field5DeepEqual(src *string) bool {
	...
	if p.CreateDate == src {
		return true
	} else if p.CreateDate == nil || src == nil {
		return false
	}
...
func (p *MessageServiceMessageChatArgs) SetReq(val *ChatRequest) {
	p.Req = val
}
...
func (p *MessageServiceMessageActionArgs) SetReq(val *ActionRequest) {
	p.Req = val
}
